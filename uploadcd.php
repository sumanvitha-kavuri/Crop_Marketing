...
<head>
    ...
    <title>Upload Crop Details - Yield Cycle</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="content-box">
        <h2>Upload Crop Details</h2>
        <form action="cropdetails.php" method="POST" enctype="multipart/form-data">
            ...
            <input type="file" id="photo" name="crop_photo" accept="image/*">
    ...
    <script>
        ...
        function redirectToCompanyDetails(event) {
            // Prevent the default form submission
            event.preventDefault();
            // Redirect to the company details page
            window.location.href = "cropdetails.php";
        }
    </script>
</body>
</html>
